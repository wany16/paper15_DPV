...
create_ip -name input_arbiter_6in -vendor NetFPGA -library NetFPGA -module_name input_arbiter_6in_ip
set_property generate_synth_checkpoint false [get_files input_arbiter_6in_ip.xci]
reset_target all [get_ips input_arbiter_6in_ip]
generate_target all [get_ips input_arbiter_6in_ip]

### PKTGEN
create_ip -name pktgen -vendor NetFPGA -library NetFPGA -module_name pktgen_ip
set_property generate_synth_checkpoint false [get_files pktgen_ip.xci]
reset_target all [get_ips pktgen_ip]
generate_target all [get_ips pktgen_ip]
